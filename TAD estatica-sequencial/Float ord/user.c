...
/*
	...
	Op:
		...
		insere_ord: procura pela pos correta e insere
		remove_ord: remove certo elem da lista
...
int main(){
	...
	while(1){
		...
		if(opc == 4){
			float elem;
			printf("\nDigite o elemento que deseja achar:\n");
			scanf("%f", &elem);
			int pos;
